...
function displayCard(Coordinates, Card, CardType) {
  if (Card == undefined) {
    return;
  } // Ends function if a card does not exist

  let linGrd = ctx.createLinearGradient(
    Coordinates.x,
    Coordinates.y,
    Coordinates.x + CardType.W,
    Coordinates.y + CardType.H
  );
  ...
  ctx.fillText(
    ...
    Coordinates.y + CardType.H - CardType.txtOffsetY,
    60
  );
...
function getGradient(element) {
  switch (element) {
    case "PYRO":
      return setGradient("#FFA360", "#FF0F00");
    case "CRYO":
      return setGradient("#36DDE8", "#065050");
    case "HYDRO":
      return setGradient("#ABE1FF", "#1D4AEC");
  }
}
...
function displayScores() {
  ...
  writeText(
    "Hydro Wins: ",
    p1LeftBaseX,
    p1BaseY + verticalSpacing * 3,
    300,
    p1Scores.hydroScore
  );

  writeText(
    p1Scores.elementScore + " / " + MATCH_WIN,
    p1RightBaseX,
    p1BaseY,
    300,
    p1Scores.elementScore
  );
  writeText(
    p1Scores.pyroScore + " / " + MATCH_WIN,
    p1RightBaseX,
    p1BaseY + verticalSpacing * 1,
    300,
    p1Scores.pyroScore
  ...
  writeText(
    "Hydro Wins: ",
    p2LeftBaseX,
    p2BaseY + verticalSpacing * 3,
    300,
    p2Scores.hydroScore
  );

  writeText(
    p2Scores.elementScore + " / " + MATCH_WIN,
    p2RightBaseX,
    p2BaseY,
    300,
    p2Scores.elementScore
  );
  writeText(
    p2Scores.pyroScore + " / " + MATCH_WIN,
    p2RightBaseX,
    p2BaseY + verticalSpacing * 1,
    300,
    p2Scores.pyroScore
